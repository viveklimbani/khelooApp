...
class AppTheme {
  var appTheme = ThemeData(
    primaryColor: KAColors.primary,
    primaryColorDark: KAColors.primary,
    buttonTheme: const ButtonThemeData(buttonColor: KAColors.themeColor),
    canvasColor: KAColors.whiteColor,
    hintColor: KAColors.hintColor,
    textSelectionTheme: const TextSelectionThemeData(
      cursorColor: KAColors.textColor,
    ),
  );
}
